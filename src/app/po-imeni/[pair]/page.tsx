  ...
  return (
    ...
    >
      ...
      <p className={styles.lede}>
        Число Имени показывает манеру самоподачи каждого из вас — как вы заявляете о себе
      ...
      <CalcCta
        title="Узнайте полную совместимость вашей пары"
        text="Число имени — только один срез. Введите даты рождения, чтобы увидеть полный разбор по всем 4 системам сервиса."
      />
    </ContentShell>
  );
}
