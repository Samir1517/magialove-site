...
export default function HDTypesHubPage() {
  ...
  return (
    ...
    >
      ...
      <CalcCta
        title="Узнайте типы вашей пары"
        text="Тип определяется по точному времени рождения — введите даты и время обоих, чтобы увидеть не только типы, но и композитный бодиграф пары."
