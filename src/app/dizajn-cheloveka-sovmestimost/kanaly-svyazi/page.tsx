...
export default function HDConnectionsHubPage() {
  ...
  return (
    ...
    >
      ...
      <CalcCta
        title="Узнайте, какие связи сложились у вас"
        text="Введите даты и время рождения обоих, чтобы увидеть реальный композитный бодиграф вашей пары и все каналы, которые в нём определены."
