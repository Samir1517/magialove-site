...
export default function HDAuthoritiesHubPage() {
  ...
  return (
    ...
    >
      ...
      <CalcCta
        title="Узнайте авторитет вашей пары"
        text="Введите даты и время рождения обоих, чтобы увидеть настоящие авторитеты — они считаются по точному моменту рождения, а не по дате."
