...
export default async function ZodiacPairPage({ params }: { params: Promise<{ pair: string }> }) {
  ...
  return (
    ...
    >
      ...
      <CalcCta
        title="Узнайте настоящую совместимость вашей пары"
        text="Знак зодиака — это только Солнце. Полный расчёт по Матрице судьбы, Нумерологии, Дизайну человека и Джйотиш учитывает гораздо больше — введите даты рождения обоих."
      />
    </ContentShell>
  );
}
