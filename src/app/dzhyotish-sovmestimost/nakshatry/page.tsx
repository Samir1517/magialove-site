  ...
  return (
    ...
    >
      ...
      <p className={styles.lede}>
        Накшатра — созвездие, в котором находилась Луна в момент вашего рождения: более точный
      ...
      <CalcCta
        ...
        text="Введите точное время и место рождения обоих — расчёт требует момента, а не только даты."
