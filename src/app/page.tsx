...
const ADVANTAGES = [
  ...
  {
    title: "Первый расчёт — сразу целиком",
    text: "Полный разбор совместимости по всем четырём системам без регистрации, прежде чем решать, идти ли глубже.",
  },
  {
  ...
  return (
    <>
        ...
        <div className={styles.heroGrid}>
          <div>
            ...
            <p className={styles.heroLede}>
              ...
              этот тест для тебя. Тест на совместимость мужчины и женщины онлайн:
            ...
            <div className={styles.heroNote}>
              Без регистрации · всё считается в твоём браузере · или{" "}
      ...
      <section className={styles.ctaBanner} aria-labelledby="cta-title">
        ...
        <p className={styles.ctaLede}>Первый расчёт совместимости — без регистрации</p>
