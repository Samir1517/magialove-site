  ...
  return (
    <ContentShell breadcrumbs={[{ label: "Главная", href: "/" }, { label: "По дате рождения" }]}>
      ...
      <p className={styles.lede}>
        Введите обе даты рождения — и сразу получите расчёт по двум системам, которым для
        точного результата не нужны ни время, ни место рождения: Матрице судьбы и Нумерологии.
        Если позже добавите точное время — откроются ещё Дизайн человека и Джйотиш.
      </p>
      ...
      <div className={styles.grid}>
        ...
        <Link href="/po-date-rozhdeniya/numerologiya-sovmestimost/" className={styles.gridLink}>
          ...
          <span className={styles.gridLinkText}>Число жизненного пути и Квадрат Пифагора вашей пары</span>
        </Link>
      </div>
    </ContentShell>
  );
