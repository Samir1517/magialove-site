          ...
          {!noTime && (
            <div className={styles.timeBlock}>
              <p className={styles.why}>
                ...
                Восходящий знак меняется ещё быстрее — на градус каждые четыре минуты, —
                поэтому ошибка даже на час уводит его в соседний. Если точного времени не
                помнишь, честнее отметить галочку выше, чем поставить приблизительное:
                расчёт будет короче, зато в нём не будет придуманного.
              </p>
