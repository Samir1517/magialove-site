...
export default function PsychomatrixHubPage() {
  ...
  return (
    ...
    >
      ...
      <CalcCta
        title="Постройте квадрат для вашей пары"
        text="Здесь — общий смысл каждой линии. Чтобы увидеть свои реальные цифры и совпадения с партнёром, введите обе даты рождения."
