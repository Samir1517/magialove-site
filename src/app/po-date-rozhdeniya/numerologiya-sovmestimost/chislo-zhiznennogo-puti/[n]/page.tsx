...
export default async function LifePathPage({ params }: { params: Promise<{ n: string }> }) {
  ...
  return (
    ...
    >
      ...
      <CalcCta
        title="Узнайте оба числа жизненного пути"
        text="Это число раскрывает суть только одного человека. Введите обе даты рождения, чтобы увидеть динамику именно вашей пары и совпадения по 8 линиям психоматрицы."
