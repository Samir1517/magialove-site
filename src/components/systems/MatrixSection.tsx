...
export function MatrixSection({
  ...
  return (
    <section className={styles.section} aria-labelledby="matrix-title">
      ...
      {detailed && (
        <div>
          {/* Две подсказки подряд читались в заголовке как «??» — второй термин
              разведён в текст, к слову, которое он объясняет. */}
          <h3 className={styles.blockTitle}>
            Октаграмма: её матрица, его — и общая
            <TermHint id="octagram" label="Октаграмма" />
          </h3>
          <p className={styles.note} style={{ marginBottom: 12 }}>
            У каждого из вас своя карта, а третья — общая — складывается из двух. Вкладки
            над схемой переключают все три. В каждой точке фигуры стоит аркан
            <TermHint id="arcana" label="Аркан" /> — одна из 22 фигур Таро, у каждой есть и
            сильная сторона, и теневая. Ромб — то, что вы принесли сами: день, месяц, год и кармический свод. Прямой
            квадрат — родовые диагонали, то, что пришло из ваших семей раньше вас; синяя
            линия на схеме — мужская линия рода, розовая — женская. В центре
