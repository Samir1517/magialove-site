    ...
    <section className={styles.section} aria-labelledby="numerology-title">
      <div className={styles.sectionHead}>
        ...
        <p className={styles.sectionLede}>
          ...
          стоит, как и разница, просто платите вы за них разным.
        </p>
      </div>
      ...
      <div>
        ...
        <p className={styles.note} style={{ marginBottom: 12 }}>
          ...
          не на его, а на пары: пустая ячейка у одного часто закрыта у второго — это и
          есть то, за что вы друг друга держите. А две густые в одном месте — то самое,
          обо что вы регулярно спотыкаетесь вдвоём.
        </p>
      ...
      <div>
        ...
        <p className={styles.note} style={{ marginBottom: 12 }}>
          ...
          слабы, поправить будет некому. Разная — усталость от чужого темпа и
          одновременно шанс увидеть то, чего сам не видишь. Ниже по каждой линии сказано,
          что именно она вам даёт и чем за это берёт.
        </p>
        <p className={styles.note} style={{ marginBottom: 12 }}>
