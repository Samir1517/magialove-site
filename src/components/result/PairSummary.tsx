      ...
      {roles.length > 0 && (
        ...
        <div className={styles.rolesBlock}>
          ...
          <p className={styles.rolesNote}>
            Роль отдаётся не по полу, а по сильным сторонам — тому, у кого больше
            сигналов в нескольких системах сразу. Если прочитанное не совпало с тем, как
            у вас на самом деле, это тоже ответ: значит, кто-то тянет не свою роль. Обычно
            именно оттуда берётся усталость, которую списывают на характер.
          </p>
